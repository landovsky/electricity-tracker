  ...
  describe "C1: monotonically non-decreasing readings" do
    ...
    context "when value is less than previous reading" do
      ...
      it "is invalid" do
        ...
        expect(reading.errors[:value_kwh]).to include(match(/must be greater than or equal to the previous reading/))
      end
    end
    ...
    context "with multiple meters" do
      ...
      it "validates each meter independently" do
        ...
        expect(secondary_reading.errors[:value_kwh]).to include(match(/must be greater than or equal to the previous reading/))
      end
    end
