...
class Dashboard::ActionFormsComponent < ApplicationComponent
  def initialize(visitors_for_checkin:, visitors_for_checkout:, meters:, last_readings:, default_visitor_id: nil, prefilled_readings: {}, default_tab: "checkin")
  ...
  attr_reader :visitors_for_checkin, :visitors_for_checkout, :meters, :last_readings, :default_visitor_id, :prefilled_readings, :default_tab
